...
This file is the binding product and design spec for the public-facing Hansard frontend.

Any future developer or coding agent working on this frontend must treat this file as the primary guardrail for:
...
- KPI summary for speeches, years, macro-topics, and languages
- a strong topic-over-time visual with event markers
- a start-here set of topic cards
- a lightweight methodology summary
- a short explanation of macro-topics, procedural noise, and multilingual clustering
...
- add vague related-event notes without sources
